...
var madek = {core:{}};
madek.core.path = cljs.nodejs.require.call(null, "path");
madek.core.Electron = cljs.nodejs.require.call(null, "electron");
madek.core.BrowserWindow = madek.core.Electron.BrowserWindow;
madek.core.crash_reporter = madek.core.Electron.crashReporter;
madek.core.Os = cljs.nodejs.require.call(null, "os");
madek.core._STAR_win_STAR_ = cljs.core.atom.call(null, null);
madek.core.app = madek.core.Electron.app;
madek.core._main = function() {
  madek.core.crash_reporter.start(cljs.core.clj__GT_js.call(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null, "companyName", "companyName", 2030952346), "Your Company Name", new cljs.core.Keyword(null, "submitURL", "submitURL", -169159433), "http://example.com/"], null)));
  cljs.nodejs.process.on("error", function(a) {
    return console.log(a);
  });
  madek.core.app.on("window-all-closed", function() {
    return cljs.core.not_EQ_.call(null, cljs.nodejs.process.platform, "darwin") ? madek.core.app.quit() : null;
  });
  return madek.core.app.on("ready", function() {
    cljs.core.reset_BANG_.call(null, madek.core._STAR_win_STAR_, new madek.core.BrowserWindow(cljs.core.clj__GT_js.call(null, new cljs.core.PersistentArrayMap(null, 2, [new cljs.core.Keyword(null, "width", "width", -384071477), 800, new cljs.core.Keyword(null, "height", "height", 1025178622), 600], null))));
    cljs.core.deref.call(null, madek.core._STAR_win_STAR_).loadURL([cljs.core.str.cljs$core$IFn$_invoke$arity$1("file://"), cljs.core.str.cljs$core$IFn$_invoke$arity$1(madek.core.path.resolve(__dirname, "../index.html"))].join(""));
    return cljs.core.deref.call(null, madek.core._STAR_win_STAR_).on("closed", function() {
      return cljs.core.reset_BANG_.call(null, madek.core._STAR_win_STAR_, null);
    });
  });
};
cljs.nodejs.enable_util_print_BANG_.call(null);
console.log([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Start descjop application on "), cljs.core.str.cljs$core$IFn$_invoke$arity$1(madek.core.Os.type()), cljs.core.str.cljs$core$IFn$_invoke$arity$1(".")].join(""));
cljs.core._STAR_main_cli_fn_STAR_ = madek.core._main;
cljs.nodejscli = {};
